      ...
      <dialog id="about-modal" className="modal modal-bottom sm:modal-middle ">
        <div className="modal-box font-augusta bg-stone-900 text-stone-100">
          ...
          <p className="py-4">
            ...
            <br /><br />
            In this place, magic breathes in every grain of wood, waiting for a worthy hand to summon its power. Step forth and claim the arcane relic you need to unleash forgotten sorceries and conquer your next adventure. Your destiny awaits, and it shall be grand indeed!
          </p>
          <form method="dialog">
