    ...
    return (
        <div className="flex gap-10 pl-2 -mt-10">
            <div className="flex flex-col">
                ...
                >
                    <img className="skull-eye" srcSet={`/.netlify/images?url=images/eye-left.png&w=640 640w, /.netlify/images?url=images/eye-left.png&w=1280 1280w, /.netlify/images?url=images/eye-left.png&w=2048 2048w`} />
            ...
            <div className="flex flex-col">
                ...
                >
                    <img className="skull-eye" srcSet={`/.netlify/images?url=images/eye-right.png&w=640 640w, /.netlify/images?url=images/eye-right.png&w=1280 1280w, /.netlify/images?url=images/eye-right.png&w=2048 2048w`} />
